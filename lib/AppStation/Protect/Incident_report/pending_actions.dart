...
class _PendingActionsState extends State<PendingActions> {
  ...
  void initState() {
    ...
    MySharedPreferences.instance
      ...
      MySharedPreferences.instance
          ...
          .then((session) async {
        populatePendingActionList(session, userid);
      });
    });
  }
  ...
  void populatePendingActionList(String sessionId, String userId) async {
    showDialog(
        barrierDismissible: false,
        context: context,
    ...
    PendingActionApiCall obj = PendingActionApiCall(sessionId, userId);
    var response = await obj.callPendingActionAPi();
