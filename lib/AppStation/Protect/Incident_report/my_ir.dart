...
class _MyIRState extends State<MyIR> {
  ...
  void initState() {
    ...
    MySharedPreferences.instance
      ...
      MySharedPreferences.instance
        ...
        populateMyIRList(session, userid);
      });
    });
  }
  ...
  void populateMyIRList(String sessionId, String userId) async {
    showDialog(
        barrierDismissible: false,
        context: context,
    ...
    var response = await obj.callMyIrAPi();
