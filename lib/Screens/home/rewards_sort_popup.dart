...
class RewardsSortPopup extends StatefulWidget {
  const RewardsSortPopup({Key? key}) : super(key: key);

  @override
  State<RewardsSortPopup> createState() => _RewardsSortPopupState();
}

class _RewardsSortPopupState extends State<RewardsSortPopup> {
  String sort_key = "";
